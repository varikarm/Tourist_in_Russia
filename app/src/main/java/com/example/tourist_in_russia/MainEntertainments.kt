...
class MainEntertainments : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener  {
        var adapter: MyAdapter? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_main_entertainments)
        ...
        list.addAll(fillArras(resources.getStringArray(R.array.entertainments),
            resources.getStringArray(R.array.entertainments_content),getImageId(R.array.entertainments_image_array)))
